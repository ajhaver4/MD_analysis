...
fig.suptitle("MARTINI3 - Pseudo-Membrane (2D)",fontsize=16)
...
# frame_text = ax_plot.text(0.8, 1.04, '', transform=ax_plot.transAxes, fontsize=12, color='black')

# # Add a vertical arrow for the Z-axis
# ax_video.annotate(
#     "Z",
#     xy=(0.9, 0.2), xycoords="axes fraction",  # Arrow head
#     xytext=(0.9, 0.05), textcoords="axes fraction",  # Arrow tail
#     arrowprops=dict(facecolor="black", edgecolor="black", arrowstyle="simple", linewidth=2),
...
output_video = "Pseudo_animation.mpeg"
# writer = animation.FFMpegWriter(fps=fps)
# ani.save(output_video, writer=writer)
writer = animation.FFMpegWriter(fps=fps, bitrate=5000)
ani.save("Pseudo_highres_animation.mp4", writer=writer, dpi=300)
