...
std_timestamps = [0.1,0.5,1,1.5,2,5,10,15,20,25,30,35,40,45,50,80]   #us
...
avg_dGs = [avg_values3D[20],avg_values2D[40]]
...
leg_size = 18
lw=2.0
fig,[ax,ax1] = plt.subplots(1,2,figsize=fig_size,sharey=True)
