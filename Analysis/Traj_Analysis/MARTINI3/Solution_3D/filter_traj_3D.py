...
for chunk in chunks:
    ...
    for i in range(chunk+step):
        ...
        comProA = pro_A.centroid(pbc=True,compound='segments')
        comProB = pro_B.centroid(pbc=True,compound='segments')
        ...
        #Uncomment for filtering bound and unbound frames
...
#Uncomment for writing bound and unbound trajectories
